...
namespace WebAPI_simple.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("Register")]
        public async Task<IActionResult> Register([FromBody] RegisterRequestDTO registerRequestDTO) // khai báo model cho Register 
        {
        ...
        [HttpPost]
        [Route("Login")]
        public async Task<IActionResult> Login([FromBody] LoginRequestDTO loginRequestDTO) // khai báo model cho Login
        {
